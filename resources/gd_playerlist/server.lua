...
local rank_special = {
	["Hacker"] =        {suffix = {x=22,y=30}, color = "white", title = "Hacker"},
	["Traficante de LSD"] =        {suffix = {x=30,y=6}, color = "white", title = "Traficante de LSD"},
	["Traficante de Cocaina"] =        {suffix = {x=30,y=6}, color = "white", title = "Traficante de cocaina"},
	["Traficante de Metanfetamina"] =        {suffix = {x=30,y=6}, color = "white", title = "Traficante de metanfetamina"},
	["Traficante de Ecstasy"] =        {suffix = {x=30,y=6}, color = "white", title = "Traficante de ecstasy"},
	["Garimpeiro de ouro"] =        {suffix = {x=39,y=15}, color = "white", title = "Garimpeiro de ouro"},
	["Garimpeiro de diamante"] =        {suffix = {x=39,y=15}, color = "white", title = "Garimpeiro de diamante"},
	["Entregador"] =        {suffix = {x=6,y=19}, color = "white", title = "Entregador"},
	["Taxi"] =        {suffix = {x=36,y=27}, color = "white", title = "Taxi"},
	["Transportador de Valores"] =        {suffix = {x=19,y=30}, color = "white", title = "Transportador de valores"},
	["Mecanico"] =        {suffix = {x=37,y=33}, color = "white", title = "Mecanico"},
	["Traficante de Tartaruga"] =        {suffix = {x=35,y=38}, color = "white", title = "Traficante de tartaruga"},
	["Traficante de Maconha"] =        {suffix = {x=19,y=3}, color = "white", title = "Traficante de maconha"},
	["Entregador Sedex"] =            {suffix = {x= 36,y=17}, color = "white", title = "Entregador Sedex"},
    ["SAMU"] =            {suffix = {x= 36,y=22}, color = "red", title = "SAMU"},
	["[PCESP] Delegado"] =            {suffix = {x= 36,y=25}, color = "black", title = "[PCESP] Delegado"},
	["[PCESP] Agente"] =            {suffix = {x= 36,y=25}, color = "black", title = "[PCESP] Agente"},
    ["[PMESP] Recruta"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Recruta"}, 
	["[PMESP] Soldado"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Soldado"}, 
	["[PMESP] Sargento"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Sargento"}, 
	["[PMESP] Capitao"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Capitao"}, 
	["[PMESP] Major"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Major"},
	["[PMESP] T. Coronel"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] T. Coronel"},
	["[PMESP] Coronel"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[PMESP] Coronel"},
	["[GRPAe] Coronel"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[GRPAe] Coronel"},
	["[GRPAe] Major"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[GRPAe] Major"},
	["[GRPAe] Capitao"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[GRPAe] Capitao"},
	["[GRPAe] Sargento"] =            {suffix = {x= 36,y=25}, color = "blue", title = "[GRPAe] Sargento"},
	
	["[ROTA] Coronel"] =            {suffix = {x= 36,y=25}, color = "gray", title = "[ROTA] Coronel"}, 
	["[ROTA] Sargento"] =            {suffix = {x= 36,y=25}, color = "gray", title = "[ROTA] Sargento"},
	["[ROTA] Soldado"] =            {suffix = {x= 36,y=25}, color = "gray", title = "[ROTA] Soldado"},
...
AddEventHandler("vRP:playerJoin", function(user_id, user, name, last_login)
    ...
    TriggerEvent("livemap:internal_AddPlayerData", id, "Trabalho", "Citizen")
